        ...
        <div className='grid lg:grid-cols-5 gap-8'>
          <div className='col-span-3 lg:col-span-2 w-full h-full shadow-xl shadow-gray-400 rounded-xl p-4'>
            <div className='lg:p-4 h-full'>
              ...
              <div>
                <h2 className='py-2 mt-8'>Mike McCullagh</h2>
                <p>Software Developer</p>
                <p className='py-4'>
                  I am looking for a full-time position. Contact
                  me and lets get it.
                </p>
              </div>
              ...
              <div>
                ...
                <div className='flex items-center justify-between py-4'>
                  <a
                    href='https://www.linkedin.com/in/mike-mccullagh-7171b5234/'
                    target='_blank'
                    rel='noreferrer'
                  >
                    <div className='rounded-full shadow-lg shadow-gray-400 p-6 cursor-pointer hover:scale-110 hover:bg-indigo-50 ease-in duration-300'>
